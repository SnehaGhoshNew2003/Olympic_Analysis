...
if user_menu == 'Athlete wise Analysis':
    try:
        ...
        st.write("DataFrame 'athlete_df':", athlete_df.head())  # Debugging line
        ...
        # Check if the next section has data
        st.write("Famous sports data:", athlete_df['Sport'].unique())  # Debugging line
        x = []
        name = []
        ...
        st.write("Selected Sport Data:", temp_df.head())  # Debugging line
        fig, ax = plt.subplots()
        ...
        st.write("Men vs Women Data:", final.head())  # Debugging line
